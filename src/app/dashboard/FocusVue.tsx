...
/** Les demandes à fort potentiel, en cartes — sous-onglet « Focus ». */
export default function FocusVue({ requests }: { requests: RequestRow[] }) {
    ...
    <div>
      ...
      {focus.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-line p-12 text-center text-ink-soft">
          Aucune demande à fort potentiel pour l&apos;instant. Elles apparaîtront ici dès qu&apos;une
          demande dépasse {SEUIL}/100.
        </div>
      ) : (
          ...
          {focus.map((r) => (
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                ...
                <Cell
                  label="Estimation"
                  value={r.estimation_prix != null ? `${Math.round(r.estimation_prix).toLocaleString("fr-FR")} €` : "—"}
                />
